...
type PaymentServiceClient interface {
	...
	GetPaymentByOrder(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
}
...
func (c *paymentServiceClient) GetPaymentByOrder(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	out := new(PaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_GetPaymentByOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	GetPaymentByOrder(context.Context, *GetPaymentRequest) (*PaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPaymentByOrder(context.Context, *GetPaymentRequest) (*PaymentResponse, error) {
...
func _PaymentService_GetPaymentByOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPaymentByOrder(ctx, req.(*GetPaymentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
